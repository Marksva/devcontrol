...
export function FormTicket() {
    ...
    return (
        <form className="bg-slate-200 mt-6 px-4 py-6 rounded border-2 border-gray-200">
            ...
            <textarea
                className="w-full border-2 rounded-md h-24 resize-none mb-2 px-2 border-gray-100"
